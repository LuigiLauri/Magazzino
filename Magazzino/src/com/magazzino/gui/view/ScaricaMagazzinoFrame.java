...
public class ScaricaMagazzinoFrame extends JFrame {
	...
	public ScaricaMagazzinoFrame() {
		...
		JLabel lblAcquirente = new JLabel("Destinatario");
		
		JComboBox comboBoxAcquirente = new JComboBox();
		...
		JLabel lblScaricaMagazzino = new JLabel("Scarica Magazzino");
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(lblAcquirente)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(comboBoxAcquirente, GroupLayout.PREFERRED_SIZE, 341, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(342)
					.addComponent(lblScaricaMagazzino, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
					.addGap(341))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(165)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblScaricaMagazzino, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
					.addGap(30)
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
						.addComponent(containerDataPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(comboBoxAcquirente, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
